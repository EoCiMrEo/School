...
# CORS with credentials support - multiple origins comma-separated
frontend_urls = os.getenv('FRONTEND_URL', 'http://localhost:4028,https://tic-tac-toe-fe-sigma.vercel.app').split(',')
...
socketio = SocketIO(app, cors_allowed_origins=frontend_urls, async_mode='gevent', message_queue=Config.REDIS_URL)
